...
def save_synced_frames(bag_path, type_map, counts, output_path,
                        ref_side='front', max_dt_ns=10_000_000_000):
    ...
    topics = (
        [ref_topic, TF_STATIC_TOPIC, TF_TOPIC, COSTMAP_TOPIC]
    ...
    for t, msg, msg_type_name, topic_name in _iter_messages_multi(bag_path, topics):
        ...
        if depth_entry is None or lidar_entry is None or costmap_entry is None or left_rgb is None or right_rgb is None or left_depth is None or right_depth is None:
            n_skipped += 1
...
def main():
    ...
    parser.add_argument('--max-sync-dt', type=float, default=10.0,
